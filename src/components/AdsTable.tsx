...
import { ActivateProduct, DeactivateProduct, DeleteProduct, RejectProduct, RestoreProduct, getProducts } from "../Redux/Apis/ads.actions";
        ...
        <span>
          <span className="flex gap-2">
            ...
            <span
              ...
              className="underline"
            >
              {isActive ? <span onClick={()=>deactivateProduct(record.producttid)}>Deactivate</span> : <span onClick={()=>activateProduct(record.producttid)}>Activate</span>}
            </span>
          </span>
        </span>
      ),
      ...
      render: (isDeleted: Boolean, record: any) => (
        <span className="flex gap-2 cursor-pointer">
          ...
          <span
            ...
            className="underline"
          >
            {isDeleted ? <span onClick={()=>restoreProduct(record.producttid)}>Restore</span>: <span onClick={()=>deleteProduct(record.producttid)}>Delete</span>}
          </span>
        </span>
      ),
    },
