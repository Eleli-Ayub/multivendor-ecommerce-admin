    ...
    return (
        <div className="flex flex-col mx-auto">
            ...
            <div className="flex  gap-4 ">
                {/* for the bars */}
                <div className="w-1/2  h-300 bg-white radius-[8px] shadow-card ">
                    <h1 className="text-center mt-2">Ads Statistics</h1>
                ...
                <div className="bg-white shadow-card p-5 radius-[8px]">
